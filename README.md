<p align="center">
  <img src="assets/logo-banner.svg" alt="Silicera Ã¢â‚¬â€ hardware-native specialization" width="520" />
</p>
...
<p align="center">
  Single-Zen Research Release Ã‚Â· Zen3 / Zen4 / Zen5 Ã‚Â· Dual MIT OR source-available proprietary<br/>
  <a href="https://github.com/theworker02/silicera">GitHub</a> Ã‚Â·
  <a href="https://thanks.dev/u/gh/theworker02">Sponsor</a> Ã‚Â·
...
|-------|-----------|------|
| **silicera** | [crates.io/crates/silicera](https://crates.io/crates/silicera) | [API (GitHub Pages)](https://theworker02.github.io/silicera/api/silicera/) Ã‚Â· [docs.rs](https://docs.rs/silicera) |
| **silicera-runtime** | [crates.io/crates/silicera-runtime](https://crates.io/crates/silicera-runtime) | [API](https://theworker02.github.io/silicera/api/silicera_runtime/) Ã‚Â· [docs.rs](https://docs.rs/silicera-runtime) |
| **silicera-lab** | [crates.io/crates/silicera-lab](https://crates.io/crates/silicera-lab) | [API](https://theworker02.github.io/silicera/api/silicera_lab/) Ã‚Â· [docs.rs](https://docs.rs/silicera-lab) |
...
Silicera treats the **physical machine** Ã¢â‚¬â€ topology, cache geometry, and measured behavior Ã¢â‚¬â€ as an input to program specialization.
...
> If **machine identity and measured cache/topology behavior** are first-class inputs, can portable binaries still dispatch **machine-appropriate** variants Ã¢â‚¬â€ with correctness gates, statistical skepticism, and safe fallbacks?
...
| CPU multiversioning | Feature leaves (AVXÃ¢â‚¬Â¦) | Decision trees over **working-set vs cache geometry** |
| ATLAS / FFTW | Search at install/build | Portable artifact + **mismatch Ã¢â€ â€™ baseline** |
...
| Runtime | Cheap dispatch, mismatch Ã¢â€ â€™ baseline, optional C ABI, profile health / staleness / retrain |
...
**Deferred:** Silicon Split YES/NO and cross-SKU divergence tables need a second measured Zen machine. Single-machine work is not blocked Ã¢â‚¬â€ use `silicera eval`.
...
| [`silicera-cli`](https://crates.io/crates/silicera-cli) | `silicera` binary Ã¢â‚¬â€ grouped CLI + flat aliases | [v0.2.0](https://crates.io/crates/silicera-cli) | [crates/silicera-cli/README.md](crates/silicera-cli/README.md) |
...
# Train Ã¢â€ â€™ verify Ã¢â€ â€™ health
...
**Silicon Split:** Machine A can be trained; Machine B remains a placeholder until a second Zen host exists Ã¢â€ â€™ verdict **UNKNOWN**.
...
silicera health out/profile.hnep          # 0Ã¢â‚¬â€œ100 integrity + confidence + staleness
...
| [ROADMAP.md](ROADMAP.md) | Current release Ã‚Â· next (second Zen host) Ã‚Â· hardening |
...
Independent systems research software Ã¢â‚¬â€ dual-licensed MIT OR source-available proprietary.
